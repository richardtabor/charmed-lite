 ...
 */
function bean_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function bean_sanitize_css( $css ) {
 ...
 */
function bean_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function bean_sanitize_email( $email, $setting ) {
 ...
 */
function bean_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function bean_sanitize_html( $html ) {
 ...
 */
function bean_sanitize_image( $image, $setting ) {
 ...
 */
function bean_sanitize_nohtml( $nohtml ) {
 ...
 */
function bean_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function bean_sanitize_number_range( $number, $setting ) {
 ...
 */
function bean_sanitize_select( $input, $setting ) {
 ...
 */
function bean_sanitize_url( $url ) {
