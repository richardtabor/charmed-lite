...
class Bean_Flickr_Widget extends WP_Widget 
{
    ...
    function __construct() {
        parent::__construct(
            'bean_flickr', // Base ID
            esc_html__( 'Flickr Photos', 'charmed' ), // Name
            array( 
                'description' => esc_html__( 'Add a Flickr feed widget.', 'charmed' ), 
    ...
    function form( $instance ) 
    {
        ...
        <p>
        <label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php esc_html_e('Title / Intro:', 'charmed') ?></label>
        ...
        <p>
        <label for="<?php echo esc_attr($this->get_field_id( 'flickrID' )); ?>"><?php esc_html_e('Flickr ID:', 'charmed') ?> (<a target="_blank" href="http://idgettr.com/">idGettr</a>)</label>
        ...
        <p>
        <label for="<?php echo esc_attr($this->get_field_id( 'type' )); ?>"><?php esc_html_e('Type:', 'charmed') ?></label>
        ...
        <p>
        <label for="<?php echo esc_attr($this->get_field_id( 'display' )); ?>"><?php esc_html_e('Display:', 'charmed') ?></label>
