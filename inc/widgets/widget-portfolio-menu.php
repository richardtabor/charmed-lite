...
class Bean_Portfolio_Menu_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			esc_html__( 'Portfolio Menu', 'charmed' ), // Name
			array(
				'description'                 => esc_html__( 'A custom loop of portfolio posts.', 'charmed' ),
	...
	function form( $instance ) {
		...
		?>
			<div class="bean-widget-notification">
				<p><?php esc_html_e( 'Please download & install the Bean Portfolio WordPress plugin to properly display this widget.', 'charmed' ); ?><br/>
				<a style="margin-top: 5px; margin-bottom: 8px;" href="https://themebeans.com/plugins/bean-portfolio" target="_blank" class="button button-secondary"><?php esc_html_e( 'Bean Portfolio &rarr;', 'charmed' ); ?></a></p>
			</div>
		<?php } ?>

		<p>
		<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php esc_html_e( 'Title:', 'charmed' ); ?></label>
		...
		<p>
		<label for="<?php echo $this->get_field_id( 'postcount' ); ?>"><?php esc_html_e( 'Number of Posts: (-1 for Infinite)', 'charmed' ); ?></label>
		<input type="text" class="widefat" id="<?php echo $this->get_field_id( 'postcount' ); ?>" name="<?php echo $this->get_field_name( 'postcount' ); ?>" value="<?php echo $instance['postcount']; ?>" />
		</p>

		<p>
		<label for="<?php echo $this->get_field_id( 'loop' ); ?>"><?php esc_html_e( 'Portfolio Loop:', 'charmed' ); ?></label>
